...
import com.CarShowroomManagement.service.CustomerService;
	...
	public CustomerDTO getCustomerById (@PathVariable("customer_id") int  customer_id)
{
	...
	@PostMapping("/assignCustomerToShowroomManager/{customerid}/{Showroommanagerid}")
	public CustomerDTO assignCustomerToShowroomManager (@PathVariable ("customerid") int customerId,
		@PathVariable("Showroommanagerid") int ShowroommanagerId)
{
	return customerService.assignCustomerToShowroomManager(customerId,ShowroommanagerId);
}
